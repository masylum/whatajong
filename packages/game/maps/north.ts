...
export const NORTH_MAP =  [
  // level 0
  [
    [n , n , 12, 12, 11, 11, 10, 10,  9,  9,  8,  8,  7,  7,  6,  6,  5,  5,  4,  4,  3,  3,  2,  2,  1,  1, n , n , n , n ],
    [n , n , 12, 12, 11, 11, 10, 10,  9,  9,  8,  8,  7,  7,  6,  6,  5,  5,  4,  4,  3,  3,  2,  2,  1,  1, n , n , n , n ],
    [n , n , n , n , 30, 30, 20, 20, 19, 19, 18, 18, 17, 17, 16, 16, 15, 15, 14, 14, 13, 13, 21, 21, n , n , n , n , n , n ],
    [n , n , n , n , 30, 30, 20, 20, 19, 19, 18, 18, 17, 17, 16, 16, 15, 15, 14, 14, 13, 13, 21, 21, n , n , n , n , n , n ],
    [57, 57, 44, 44, 43, 43, 29, 29, 28, 28, 27, 27, 26, 26, 25, 25, 24, 24, 23, 23, 22, 22, 34, 34, 33, 33, 32, 32, 31, 31],
    [57, 57, 44, 44, 43, 43, 29, 29, 28, 28, 27, 27, 26, 26, 25, 25, 24, 24, 23, 23, 22, 22, 34, 34, 33, 33, 32, 32, 31, 31],
    [n , n , 56, 56, 55, 55, 42, 42, 41, 41, 40, 40, 39, 39, 38, 38, 37, 37, 36, 36, 35, 35, 46, 46, 45, 45, n , n , n , n ],
    [n , n , 56, 56, 55, 55, 42, 42, 41, 41, 40, 40, 39, 39, 38, 38, 37, 37, 36, 36, 35, 35, 46, 46, 45, 45, n , n , n , n ],
    [n , n , n , n , 67, 67, 54, 54, 53, 53, 52, 52, 51, 51, 50, 50, 49, 49, 48, 48, 47, 47, 58, 58, n , n , n , n , n , n ],
    [n , n , n , n , 67, 67, 54, 54, 53, 53, 52, 52, 51, 51, 50, 50, 49, 49, 48, 48, 47, 47, 58, 58, n , n , n , n , n , n ],
    [n , n , n , n , n , n , 66, 66, 65, 65, 64, 64, 63, 63, 62, 62, 61, 61, 60, 60, 59, 59, n , n , n , n , n , n , n , n ],
    [n , n , n , n , n , n , 66, 66, 65, 65, 64, 64, 63, 63, 62, 62, 61, 61, 60, 60, 59, 59, n , n , n , n , n , n , n , n ],
